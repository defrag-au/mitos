...
`mitos-community-events` (e.g. `mitos_community_events::jpg_co`).
Consumers (`cnft.dev-workers` companions) depend on that single
crate rather than per-module events crates.
